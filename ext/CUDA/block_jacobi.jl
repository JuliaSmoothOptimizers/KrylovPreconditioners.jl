...
KP.BlockJacobiPreconditioner(J::CUSPARSE.CuSparseMatrixCOO; options...) = BlockJacobiPreconditioner(SparseMatrixCSC(J); options...)
...
KP.kp_block_jacobi(J::CUSPARSE.CuSparseMatrixCOO) = KP.BlockJacobiPreconditioner(J; device=CUDABackend())
